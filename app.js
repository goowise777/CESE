...
const translations = {
  en: {
    ...
    about_eyebrow: "COMPANY_OVERVIEW_EST_2011",
    about_title: "Bridging the Gap in Gulf Industrial Supply",
    about_p1: "For over a decade, Commercial Electricity Supply Establishment (CESE) has served as a specialized distributor of industrial automation controls, sensors, pneumatics, and power transmission products across the Kingdom of Saudi Arabia and the broader GCC.",
    ...
    contact_addr: "Building 12, Industrial Road, Jubail City 35514,\nKingdom of Saudi Arabia",
  ...
  ar: {
    ...
    tag_ksa: "الجبيل / الرياض، السعودية",
    ...
    about_eyebrow: "لمحة_عن_الشركة_تأسست_٢٠١١",
    about_title: "سد الفجوة في التوريدات الصناعية الخليجية",
    about_p1: "لأكثر من عقد من الزمان، عملت مؤسسة توريد الكهرباء التجارية كعضو وموزع متخصص في أنظمة التحكم بالأتمتة الصناعية، وأجهزة الاستشعار، والمكونات الهوائية، ومنتجات نقل الطاقة في جميع أنحاء المملكة العربية السعودية والخليج العربي.",
    ...
    contact_addr: "المبنى ١٢، طريق الصناعية، مدينة الجبيل ٣٥٥١٤،\nالمملكة العربية السعودية",
...
/* ==========================================================================
   5. RFQ FORM VALIDATION & SIMULATION
   ========================================================================== */
...
function initRfqForm() {
  ...
  form.addEventListener('submit', (e) => {
    ...
    setTimeout(() => {
      ...
      // Random transaction ID for RFQ code
      const rfqId = Math.floor(100000 + Math.random() * 900000);
      const successMessage = translations[currentLang].form_success.replace('%ID%', rfqId);
